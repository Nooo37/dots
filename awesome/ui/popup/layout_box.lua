...
local some_factor_in_the_middle = all_factors[math.floor(#all_factors/2)+1] -- one is nill so "+1"
...
local ll = awful.widget.layoutlist {
    ...
    widget_template = {
        ...
        forced_width    = 50,
        forced_height   = 50,
        shape           = gears.shape.hexagon, ---helpers.rrect(beautiful.corner_radius),
