...
colors.statusline_bg = colors.bg
...
gls.left[4] = {
    FileName = {
        ...
        highlight = {colors.white, colors.black},
        separator = " ",
        separator_highlight = {colors.black, colors.black2}
    }
}
...
gls.left[5] = {
    current_dir = {
        ...
        highlight = {colors.grey_fg2, colors.black2},
        separator = " ",
        separator_highlight = {colors.black2, colors.statusline_bg}
    }
}
