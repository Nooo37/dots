...
local Bintree      = require("layout.treetile.bintree") -- might be changed depending on your dir structure
local os           = os
local math         = math
local ipairs       = ipairs
local pairs        = pairs
...
-- Layout icon
beautiful.layout_treetile = os.getenv("HOME") .. "/.config/awesome/layout/treetile/layout_icon.png"
